var projects = [
    {
        ...
        description: '<h4>Overview</h4>'
            ...
            + '<p>The game was built in Unity using C#. Level design focused on creating a sense of speed and urban chaos while keeping controls intuitive.</p>'
            + '<h4>Challenges</h4>'
    ...
    },
    {
        ...
        description: '<h4>Overview</h4>'
            + '<p>Reverse 2048 is a strategic puzzle game and the inverse of the classic 2048 where instead of building tiles up to 2048, players must systematically reduce tiles down to the smallest possible value of 2. The project implemented and evaluated two competing AI algorithms designed to solve any valid board configuration across 3×3, 4×4, and 5×5 grids with initial tile values of 128, 256, or 512. The game ends when either a tile reaches 2, the 1000-move limit is exceeded, or no valid merges remain.</p>'
            + '<h4>Design &amp; Development</h4>'
